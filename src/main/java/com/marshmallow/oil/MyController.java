...
public class MyController {
    ...
    /**
     * Test function to allow me understanding oh how JSON data is processed by Jackson
     ...
     */
    @RequestMapping(value = "robot-cleaner-doNotUse", method = RequestMethod.POST)
     ...
     */
    @RequestMapping(value = "test-cleaner-doNotUse", method = RequestMethod.POST)
